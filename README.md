...
## Overview
This project is an interactive# 🌆 Smart City Dashboard
...
# ⭐ If you like this project, give it a star on GitHub! Power BI dashboard designed to analyze smart city data including crime analysis, air quality, traffic insights, and population statistics.
...
- Dynamic Filters
- India Map Integration using JSON
...
## Project Structure
- PowerBI_Dashboard → Main Power BI file
- Dataset → Source datasets
- Assets → Logos, wallpapers, JSON files
